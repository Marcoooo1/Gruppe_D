...
//  Funktion: Liest laser_output.json und liefert float*
...
float* loadLaserAsFloatArray(std::size_t& outSize)
{
    ...
    // ranges kopieren (ohne float-Rundung – get<float>() mappt exakt)
...
int main()
{
    ...
    // Beispiel: Übergabe des Pointers müssen wir noch angeben
